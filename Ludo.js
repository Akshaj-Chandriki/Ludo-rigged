...
export class Ludo {
    ...
    if (this.turn === 0) {
        ...
        // Auto-winning number near finish
        [0,1,2,3].forEach(piece => {
            ...
            if (
                ...
                !BASE_POSITIONS[player].includes(pos)
            ) {

                const need = HOME_POSITIONS[player] - pos;
        ...
        if (forcedMove !== null) {
            ...
            this.diceValue = nums[Math.floor(Math.random() * nums.length)];
        }
